...
export const SITE: SiteConfig = {
  ...
  author: {
    ...
    avatar: avatarImg,
    bio: 'Security Engineer by day, hacker by curiosity. I write about offensive security, cloud-native defense, and the CNCF ecosystem — because breaking things is how you learn to build them right.',
  },
  /** Default OG image. */
